...
def predict_single_image(img, model_rpn, model_classifier_only, cfg, class_mapping):
    st = time.time()
...
print("oshi156hang:meiyouchucuo")
...
def recognition(image ):
    with graph.as_default():
        return predict_single_image(image, model_rpn, model_classifier_only, cfg, class_mapping)
